...
var render = {
  ...
  initContainer: function initContainer() {
    ...
    var containerData = {
      width: Math.max(container.offsetWidth || doc.clientWidth, Number(options.minContainerWidth) || 200),
      height: Math.max(container.offsetHeight || doc.clientHeight, Number(options.minContainerHeight) || 100)
    };
