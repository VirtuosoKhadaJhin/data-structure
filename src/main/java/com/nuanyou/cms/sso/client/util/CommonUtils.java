...
import com.nuanyou.cms.sso.client.proxy.ProxyGrantingTicketStorage;
import com.nuanyou.cms.sso.client.validation.ProxyList;
import com.nuanyou.cms.sso.client.validation.ProxyListEditor;
...
public final class CommonUtils {
     ...
     * @param gateway where we should send gateway or not.   @return the fully constructed redirect url.
     * */
    public static String constructRedirectUrl(final String casServerLoginUrl, final String serviceParameterName, final String serviceUrl, final String state, Boolean relogin, final boolean renew, final boolean gateway) {
        try {
        String url= casServerLoginUrl + (casServerLoginUrl.indexOf("?") != -1 ? "&" : "?") + serviceParameterName + "="
